...
# Bootstrap refreshed keyrings to avoid Ubuntu 24.04/NVIDIA GPG signature errors
RUN set -eux; \
    ...
    apt-get install -y --no-install-recommends --allow-unauthenticated \
        ...
        ubuntu-keyring \
        wget; \
    # Refresh NVIDIA CUDA repo keyring (for ubuntu2404)
    wget -qO /usr/share/keyrings/cuda-archive-keyring.gpg https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/x86_64/cuda-archive-keyring.gpg || true; \
